...
|----|----------|---------|--------|---------------|
| T-B01 | `python3 -m pytest tests/ -q` | 96+ passed | [x] | 2026-07-07 |
...
|----|---------------------|---------|--------|---------------|
| T-G01 | `pytest tests/test_groups.py::test_create_group` | founder immuable | [ ] | — |
| T-G02 | `test_founder_cannot_be_removed_by_admin` | 403 FOUNDER_IMMUTABLE | [ ] | — |
| T-G03 | `test_only_founder_promotes_admin` | admin role set | [ ] | — |
| T-G04 | `test_admin_cannot_promote_admin` | 403 | [ ] | — |
| T-G05 | `test_dissolve_group_founder_only` | groupe archivé | [ ] | — |
| T-G06 | `POST /groups` + `GET /groups` API | données réelles JSON | [ ] | — |
| T-G07 | `POST /store` visibility=group + group_id | bloc scoped | [ ] | — |
| T-G08 | `GET /chain?group_id=` filtre | membres only | [ ] | — |
...
| **1** | Backend GroupManager + API | 20 % | T-G01–G08 |
...
**Avancement dashboard global : 45 %**
...
**Dernière mise à jour :** 2026-07-07T05:15:00Z
