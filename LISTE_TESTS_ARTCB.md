...
**Avancement tests dashboard : 100 %**
...
|----|----------|---------|--------|---------------|
| T-B01 | `python3 -m pytest tests/ -q` | 96+ passed | [x] | 2026-07-07 (132) |
...
| T-F11 | V10 Créer groupe + inviter | API groups | [x] | 2026-07-07 |
...
4. Référencer `rapports/048_*.md` après session finale.
5. PROTOCOLE : pas de mock — tests API = serveur réel ou TestClient avec fichiers réels.

---

**Dernière mise à jour :** 2026-07-07T07:00:00Z
